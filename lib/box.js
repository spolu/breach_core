...
var box = function(spec, my) {
  ...
  var shortcut_stack_search;   /* shortcut_stack_search(); */
  ...
  init = function(cb_) {
    ...
    my.session.keyboard_shortcuts().on('stack_search', shortcut_stack_search);
  };
  ...
  // ### shortcut_stack_search
  //
  // Keyboard shortcut to trigger stack search
  shortcut_stack_search = function() {
    console.log('STACH SEARCH-');
    my.mode_value = '/';
    that.focus(function() {
      push();
    });
