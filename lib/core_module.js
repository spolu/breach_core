...
var core_module = function(spec, my) {
  ...
  // #### _exposed_
  //
  var control_set;           /* control_set(args, cb_); */
  var control_unset;         /* control_unset(args, cb_); */
  var control_dimension;     /* control_dimension(args, cb_); */
  ...
  init = function(cb_) {
    ...
    */
    ...
    my.session.get_module_manager().core_expose('control_set', control_set);
    my.session.get_module_manager().core_expose('control_unset', control_unset);
    my.session.get_module_manager().core_expose('control_dimension', control_dimension);
