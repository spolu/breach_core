...
var core_module = function(spec, my) {
  ...
  init = function(cb_) {
    ...
    */
    ...
    my.session.module_manager().core_expose('tabs_tag', my.core_tabs.tabs_tag);
    my.session.module_manager().core_expose('tabs_untag', my.core_tabs.tabs_untag);
    ...
    my.session.module_manager().core_expose('control_set', my.core_controls.control_set);
    my.session.module_manager().core_expose('control_unset', my.core_controls.control_unset);
    my.session.module_manager().core_expose('control_dimension', my.core_controls.control_dimension);
    my.session.module_manager().core_expose('control_focus', my.core_controls.control_focus);
