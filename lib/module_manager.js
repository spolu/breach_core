...
var module_manager = function(spec, my) {
  ...
  stop_module = function(module, cb_) {
    if(my.modules[module.module_id]) {
      ...
      my.pending_modules = my.modules[module.module_id];
      ...
      my.modules[module.module_id].process.removeListener('exit');
      my.modules[module.module_id].process.on('exit', function() {
